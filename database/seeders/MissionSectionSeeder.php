    ...
    public function run(): void
    {
        MissionSection::updateOrCreate(
            ...
            [
                ...
                'mission_1_fr' => 'Défendre les droits et la dignité des femmes',
                'mission_1_en' => 'Defend the rights and dignity of women',
                ...
                'mission_3_fr' => 'Réduire la pauvreté par l\'autonomie économique',
                'mission_3_en' => 'Reduce poverty through economic empowerment',
                'mission_3_icon' => self::LINK,
                'mission_4_fr' => 'Lutter contre la pollution pour un environnement sain',
                'mission_4_en' => 'Fight pollution for a healthy environment',
                'mission_4_icon' => self::LEAF,
                'mission_5_fr' => 'Prévenir les maladies évitables',
                'mission_5_en' => 'Prevent preventable diseases',
