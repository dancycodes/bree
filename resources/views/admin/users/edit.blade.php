...
@section('breadcrumb', 'Utilisateurs › ' . $user->name)
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6" style="border: 1px solid #e2e8f0;">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-medium mb-1.5" style="color: #374151;">
                                    Nouveau mot de passe
                                    <span class="font-normal" style="color: #94a3b8;">(laisser vide pour ne pas changer)</span>
                                </label>
                            ...
                            <div>
                                <label class="block text-xs font-medium mb-1.5" style="color: #374151;">Confirmer</label>
            ...
            <div class="space-y-5">
                ...
                <div class="flex flex-col gap-2">
                    <button @click="$action.patch('{{ route('admin.users.update', $user) }}', { include: ['name','email','password','password_confirmation','is_active','roles'] })"
