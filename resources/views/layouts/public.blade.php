                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm" style="color: rgba(255,255,255,0.6);">
                        <li class="flex items-start gap-3">
                            ...
                            <a href="mailto:contact@breefondation.org" class="hover:text-white transition-colors">
                        ...
                        <li class="flex items-start gap-3">
                            ...
                            <span>+41 22 345 69 89</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="w-4 h-4 mt-0.5 flex-shrink-0" style="color: #c8a03c;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                            <a href="https://www.breefondation.org" target="_blank" rel="noopener" class="hover:text-white transition-colors">
                                www.breefondation.org
                            </a>
                        </li>
                    </ul>
